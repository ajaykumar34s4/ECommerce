...
const Payment = () => {
  ...
  useEffect(() => {
    setSubtotalAmount(Number(localStorage.getItem("before")) || 0);
    setDeliveryCharges(Number(localStorage.getItem("perce")) || 0);
    setTotalAmount(Number(localStorage.getItem("total")) || 0);
    setTotalItems(Number(localStorage.getItem("toItems")) || 0);
  }, []);
